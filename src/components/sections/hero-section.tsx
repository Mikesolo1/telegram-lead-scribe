...
export function HeroSection() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-white to-secondary/50 pt-16 pb-20">
      <Container className="relative">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[400px] md:h-[500px] w-full rounded-xl bg-gradient-to-br from-primary/5 to-primary/10 border overflow-hidden">
